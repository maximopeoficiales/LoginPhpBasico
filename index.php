...
if (isset($_POST["registrar"])) {
	/* mysqli_real_escape_string usa la codificacion de la bd, evita ataque de inyeccion */
	$nombre = mysqli_real_escape_string($conexion, $_POST['nombre']);
	$correo = mysqli_real_escape_string($conexion, $_POST['correo']);
	$usuario = mysqli_real_escape_string($conexion, $_POST['user']);
	$password = mysqli_real_escape_string($conexion, $_POST['pass']);
	$password_encriptada = sha1($password);/* codifica el pass */
	/* verificacion del usuario existente */
	$verificacion = "SELECT idusuario FROM usuarios WHERE usuario= '$usuario'";
	$result_verificacion = $conexion->query($verificacion);
	$filas = $result_verificacion->num_rows;/* obtiene el numero de filas del resultado */
	if ($filas > 0) {
		echo "
		<script>
							...
							<div id="signup-box" class="signup-box widget-box no-border">
								<div class="widget-body">
									<div class="widget-main">
										...
										<!-- $_SERVER["PHP_SELF"] direcciona a la pagina raiz -->
										<form action="<?php $_SERVER["PHP_SELF"]; ?>" method="POST">
											<fieldset>
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
